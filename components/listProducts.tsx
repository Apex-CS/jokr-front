...
import { IconButton, Modal,Button,Table,Box,TableBody,TableCell,TableContainer,TableHead,
...
function listProducts(props:{user:User,key:number}) {
  ...
  const editData = { id:user.id, sku:user.sku,name:user.name, description: user.description, price:user.price ,is_active: user.is_active ,created_at: user.created_at,updated_at: user.updated_at,
  stock:user.stock,photo_file_name: user.photo_file_name}
        ...
        <>
          <TableRow hover>
            ...
            <TableCell align="right">
                <IconButton  color="warning" onClick={changeStateEdit}>< BorderColorIcon/></IconButton>
